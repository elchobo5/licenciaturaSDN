...
for ($i = 0; $i < 73; $i++) {
	...
	if ($profundidad < 2) {
		...
		$arreglo["links"][0]["switches"][$i]["connected_nodes"][2]["name"] = "h".($hostArbol + 2);
		$arreglo["links"][0]["switches"][$i]["connected_nodes"][3]["name"] = "h".($hostArbol + 3);
		$arreglo["links"][0]["switches"][$i]["connected_nodes"][4]["name"] = "h".($hostArbol + 4);
		$arreglo["links"][0]["switches"][$i]["connected_nodes"][5]["name"] = "h".($hostArbol + 5);
		$arreglo["links"][0]["switches"][$i]["connected_nodes"][6]["name"] = "h".($hostArbol + 6);
		$arreglo["links"][0]["switches"][$i]["connected_nodes"][7]["name"] = "h".($hostArbol + 7);
